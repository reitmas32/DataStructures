...
template <typename ItemOne, typename ItemTwo>
bool Map<ItemOne,ItemTwo>::Map_Insert(ItemOne key, ItemTwo value){
	int h = 0;
...
template <typename ItemOne, typename ItemTwo>
bool Map<ItemOne,ItemTwo>::Map_Retrieve(ItemOne key, ItemTwo* value){
	int h=0;
...
template <typename ItemOne, typename ItemTwo>
bool Map<ItemOne,ItemTwo>::Map_Remove(ItemOne key){
	size_t loc = this -> hash(key,this -> size);
	size_t i = loc;
	int h= 0;
	bool done = false;
...
template <typename ItemOne, typename ItemTwo>
size_t Map<ItemOne,ItemTwo>::Map_Iterator(void (*pfun)( ItemOne id, ItemTwo sueldo )){
	size_t cnt = 0;
...
template <typename ItemOne, typename ItemTwo>
size_t Map<ItemOne,ItemTwo>::Map_Len(){
	return this -> len;
}

template <typename ItemOne, typename ItemTwo>
size_t Map<ItemOne,ItemTwo>::Map_size(){
	return this -> size;
}